...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h5 class="reply-msg"><i class="bi bi-truck reply-icon"></i><br>Your Booking has done successfully.<br><br>Your Book is on the Way.</h5>
    <h6 class="reply-msg">Return to <a href="dashboard.php">Dashboard</a></h6>
  </body>
</html>
